...
layout: post
comments: true
title: "Rising against failure and head fakes." 
excerpt: "Retrospecting recent failures and maneuvering head fakes of my life."
date: 2018-02-02 +0530
mathjax: true
...
You don't like Rick and Morty? [Probably you don't have much IQ](https://www.reddit.com/r/copypasta/comments/6qhaln/only_high_iqs_watch_rick_and_morty/). Sorry for that meme.
...
A wave comes and goes and so does your life and the events. There's always something good brewing up. 
...
$$\mathcal{F}(\text{life}) = \sum_{t=0}^{\infty} (a_t \cos(tx) + b_t \sin(ty)) $$

$$a_t = \text{realization}$$ 
$$b_t = \text{headfakes and redemption phases}$$
...
Machines have love too. Some kind of love. _Yes, that's the title._
...
<div class="imgcap ">
<img src="/assets/headfake/rpausch.jpg" width="100%" height="80%">
<div class="thecap" style="text-align:center">
...
My future still has hope just like the [Rebellion](https://en.wikipedia.org/wiki/Rebel_Alliance) in the universe. 
The world doesn't need men and women who bow to the corruptness. 
